...
const QUESTIONS = {
  easy: [
    { question: "Jaká je jednotka SI pro elektrický odpor?",
      options: { A: "Volt", B: "Ampér", C: "Ohm", D: "Watt" }, correct: "C" },
    { question: "Ohmův zákon říká, že napětí (V) se rovná:",
      options: { A: "I + R", B: "I × R", C: "I / R", D: "I² × R" }, correct: "B" },
    { question: "Jaký typ proudu produkuje standardní baterie?",
      options: { A: "Střídavý (AC)", B: "Stejnosměrný (DC)", C: "Pulzující", D: "Smíšený" }, correct: "B" },
    { question: "Jaká je jednotka SI pro elektrický výkon?",
      options: { A: "Joule", B: "Coulomb", C: "Watt", D: "Tesla" }, correct: "C" },
  ],
  medium: [
    { question: "Baterie 12 V je připojena k rezistoru 4 Ω. Jaký je proud?",
      options: { A: "48 A", B: "3 A", C: "0,33 A", D: "8 A" }, correct: "B" },
    { question: "Dva stejné rezistory 6 Ω jsou zapojeny paralelně. Celkový odpor?",
      options: { A: "12 Ω", B: "6 Ω", C: "3 Ω", D: "1 Ω" }, correct: "C" },
    { question: "Standardní frekvence střídavého proudu v Evropě:",
      options: { A: "25 Hz", B: "50 Hz", C: "60 Hz", D: "100 Hz" }, correct: "B" },
    { question: "Spotřebič odebírá 2 A při 110 V. Jaký je jeho příkon?",
      options: { A: "55 W", B: "112 W", C: "220 W", D: "440 W" }, correct: "C" },
  ],
  hard: [
    { question: "Transformátor má poměr závitů 1:10. Vstup je 20 V. Výstupní napětí?",
      options: { A: "2 V", B: "20 V", C: "100 V", D: "200 V" }, correct: "D" },
    { question: "Rezistory 2 Ω, 3 Ω a 6 Ω jsou zapojeny v sérii. Celkový odpor?",
      options: { A: "1 Ω", B: "6 Ω", C: "11 Ω", D: "18 Ω" }, correct: "C" },
    { question: "Kirchhoffův zákon proudů: součet všech proudů v uzlu se rovná:",
      options: { A: "Napětí", B: "Odpor", C: "Nule", D: "Výkonu" }, correct: "C" },
    { question: "Kolik energie uloží kondenzátor 100 μF nabitý na 10 V?",
      options: { A: "500 μJ", B: "1 000 μJ", C: "5 000 μJ", D: "10 000 μJ" }, correct: "C" },
  ],
};

const ROUNDS = [
  { key: "easy",   label: "KOLO 1", subtitle: "Základní pojmy",    time: 60, swing: 5,  badge: "#4ade80" },
  { key: "medium", label: "KOLO 2", subtitle: "Aplikovaná fyzika", time: 50, swing: 8,  badge: "#fbbf24" },
  { key: "hard",   label: "KOLO 3", subtitle: "Pokročilé úlohy",   time: 40, swing: 12, badge: "#f87171" },
];
